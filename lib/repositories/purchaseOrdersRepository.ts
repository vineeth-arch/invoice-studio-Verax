...
function mergePurchaseOrderImages(cloudPO: PurchaseOrder, localPO?: PurchaseOrder | null): PurchaseOrder {
  ...
  return {
    ...
    buyer: {
      ...cloudPO.buyer,
      logoImageBase64: localPO.buyer?.logoImageBase64,
    },
    preparedBySignature: cloudPO.preparedBySignature
      ? { ...cloudPO.preparedBySignature, signatureImageBase64: localPO.preparedBySignature?.signatureImageBase64 }
      : localPO.preparedBySignature,
    approvedBySignature: cloudPO.approvedBySignature
      ? { ...cloudPO.approvedBySignature, signatureImageBase64: localPO.approvedBySignature?.signatureImageBase64 }
      : localPO.approvedBySignature,
    vendorAcceptanceSignature: cloudPO.vendorAcceptanceSignature
      ? { ...cloudPO.vendorAcceptanceSignature, signatureImageBase64: localPO.vendorAcceptanceSignature?.signatureImageBase64 }
...
function fromCloudPurchaseOrder(row: PurchaseOrderRow, localPO?: PurchaseOrder | null): PurchaseOrder {
  ...
  return mergePurchaseOrderImages({ ...base, id: row.id, updatedAt: row.updated_at, createdAt: row.created_at }, localPO);
}
